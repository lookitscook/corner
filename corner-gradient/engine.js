...
(function (root) {
  ...
  root.CornerEngine = Object.freeze({ clamp, copyPoints, wavePoints, segments, evaluate,
    radialLUT, transferLUT, colorRGB, prepare, render, renderAsync });
  if (typeof module !== 'undefined' && module.exports) module.exports = root.CornerEngine;
